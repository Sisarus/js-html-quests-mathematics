...
function startData() {
    ...
    let tieto = new Kysymys(
            ...
            "Taisto Hanhi",
            "Aleksis Kivi",
            '<img src="../img/luomanmaki_img/elias.png" class="img-fluid" alt=""/>',
    ...
    tieto = new Kysymys(
            ...
            "Käärme",
            "Lohkare",
            '<img src="../img/luomanmaki_img/louhi.png" class="img-fluid" alt=""/>',
    ...
    tieto = new Kysymys(
            ...
            "Jousipyssyn",
            "Oven",
            '<img src="../img/luomanmaki_img/hauki.png" class="img-fluid" alt=""/>',
    ...
    tieto = new Kysymys(
            ...
            '<img src="../img/luomanmaki_img/sampo.png" class="img-fluid" alt=""/>',
    ...
    tieto = new Kysymys(
            ...
            "Väinämöinen",
            "Kullervo",
            '<img src="../img/luomanmaki_img/seppa.png" class="img-fluid" alt=""/>',
    ...
    tieto = new Kysymys(
            ...
            "Muurahainen",
            "Kottarainen",
            '<img src="../img/luomanmaki_img/aiti.png" class="img-fluid" alt=""/>',
    ...
    tieto = new Kysymys(
            ...
            "Kuutar",
            "Vedetär",
            '<img src="../img/luomanmaki_img/vainamoinen.png" class="img-fluid" alt=""/>',
    ...
    tieto = new Kysymys(
            ...
            "Miekoin",
            "Nyrkein",
            '<img src="../img/luomanmaki_img/taistelu.png" class="img-fluid" alt=""/>',
    ...
    tieto = new Kysymys(
            ...
            "Ihmissusi",
            "Zombie",
            '<img src="../img/luomanmaki_img/hirvio.png" class="img-fluid" alt=""/>',
    ...
    tieto = new Kysymys(
            ...
            '<img src="../img/luomanmaki_img/aino.png" class="img-fluid" alt=""/>',
